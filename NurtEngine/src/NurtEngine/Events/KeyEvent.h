...
namespace NurtEngine {
	...
	class NURTENGINE_API KeyPressedEvent : public KeyEvent
	{
	public:
	...
	class NURTENGINE_API KeyReleasedEvent : public KeyEvent
	{
	public:
	...
	class NURTENGINE_API KeyTypedEvent : public KeyEvent
	{
	public:
